        ...
        <div className="max-w-4xl mx-auto flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-2xl bg-gradient-to-r from-[#ff85a2] to-[#ff5a8a] text-white hover:opacity-95 shadow-md shadow-[#ff5a8a]/20 text-xs font-bold flex items-center gap-1.5 transition-all"
              title={t.addCharacter}
            >
              <Plus className="w-4 h-4" />
              <span className="hidden sm:inline">{t.addCharacter}</span>
            </button>
