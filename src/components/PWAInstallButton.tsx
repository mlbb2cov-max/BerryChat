                ...
                <div className="flex items-start gap-2.5 p-2.5 rounded-xl bg-[#2e222c] border border-[#3d2b38]">
                  ...
                  <div>
                    {isMy ? (
                      ...
                      <span>
                        Tap the <Share2 className="w-3.5 h-3.5 inline text-[#ff85a2]" /> <strong>Share</strong> button at the bottom of Safari.
                      </span>
                    )}
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2.5 p-2.5 rounded-xl bg-[#2e222c] border border-[#3d2b38]">
                  ...
                  <div>
                    {isMy ? (
                      ...
                      <span>
                        Tap <strong>"Add"</strong> in the top right. Berry AI will open like a native app on your home screen!
                      </span>
                    )}
                  </div>
                </div>
