          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-sm font-bold text-white flex items-center gap-1.5">
                <span>{isMy ? 'Barrychat ကို ထောက်ပံ့လှူဒါန်းရန်' : 'Donate & Support Barrychat'}</span>
                <Sparkles className="w-3.5 h-3.5 text-[#ffb86c]" />
              </h3>
              <p className="text-[11px] text-[#a0909c]">KBZPay QR Payment</p>
            </div>
          </div>
          <button
          ...
          >
            ...
            <div className="w-full aspect-square max-w-[260px] bg-white rounded-2xl p-4 shadow-xl flex items-center justify-center relative overflow-hidden">
              <img
                ...
                alt="KBZPay QR Code - Oakar Khant"
            ...
            <div className="mt-4 text-center">
              <div className="inline-block px-3 py-1 rounded-full bg-black/20 backdrop-blur-xs border border-white/20">
                <p className="text-white font-semibold text-sm sm:text-base tracking-wide font-mono">
                  Oakar Khant(*******8676)
                </p>
              </div>
            </div>
          ...
          <div className="text-center px-4 mt-1">
            <p className="text-[11px] text-[#a0909c] leading-relaxed">
              {isMy
                ...
                : 'Your kind donation directly keeps Barrychat fast, free, and constantly updated for everyone! ❤️'}
            </p>
          </div>
        </div>
      </div>
