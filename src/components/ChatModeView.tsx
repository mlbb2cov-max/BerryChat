...
import { Character, ChatMessage, MessagePart } from '../types';
import {
  Send,
  Image as ImageIcon,
  X,
        ...
        {messages.length === 0 ? (
          <div className="h-full flex flex-col items-center justify-center text-center p-6 space-y-3">
            ...
            <p className="text-xs text-[#a0909c] max-w-xs leading-relaxed">
              Send a text or photo to start your conversation. Switch to Real
              Mode at any time to meet face-to-face!
            </p>
          </div>
        ) : (
                  ...
                  >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <span className="text-xs font-bold text-white group-hover:text-[#ff85a2] transition-colors">
                            {msg.encounterTitle || 'In-Person Meet Encounter'}
                          </span>
                    ...
                    <div className="flex items-center justify-between pt-1">
                      <span className="text-[11px] text-[#ff85a2] font-semibold flex items-center gap-1 group-hover:underline">
                        ...
                        View Meet Mode details (read-only)
                      </span>
          ...
          <div className="flex items-end gap-2">
            ...
            <div className="flex-1 relative rounded-2xl bg-[#2e222c] border border-[#3d2b38] focus-within:border-[#ff85a2] transition-colors overflow-hidden">
              <textarea
                ...
                rows={1}
                className="w-full px-3.5 py-2.5 bg-transparent text-white text-sm focus:outline-none resize-none max-h-36 placeholder-[#a0909c]"
              />
            </div>
