      ...
      >
        ...
        <div className="px-5 py-4 border-b border-[#3d2b38] flex items-center justify-between bg-[#2e222c]">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-base font-bold text-white">Saved Bookmarks</h3>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3">
          {bookmarks.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-center p-6 space-y-3">
              ...
              <h4 className="text-sm font-bold text-white">No Bookmarks Saved</h4>
              <p className="text-xs text-[#a0909c] max-w-xs leading-relaxed">
                Click the bookmark icon on any message in chat or story mode to save memorable quotes here.
              </p>
            </div>
          ) : (
            bookmarks.map((bm) => (
